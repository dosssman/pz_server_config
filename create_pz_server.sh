...
RESPONSE=$(curl "https://api.vultr.com/v2/instances" \
  ...
  --data '{"region":"cdg", "plan":"vc2-2c-4gb", "label":"PZSteamDediServerNode", "os_id":387, "sshkey_id":["a6fb92f8-b8d1-47c9-9511-8f2dc116714b","6bc9749a-ad09-4d35-add4-fc41afeb8341","164f25b6-55ff-44c8-a82c-f2bb784fd766"], "script_id": "e1e46aeb-b960-42b4-a63d-9a6a16d258e5","backups":"disabled","hostname":"PZSteamDediServerNode"}')
